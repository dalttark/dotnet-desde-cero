...
public class UserService : IUserService
{
    ...
    public async Task<AuthRespondeDto> AddUserAsync(RegisterRequetDto request)
    {
        var response = new AuthRespondeDto();
        try
        {
    ...
    public async Task<AuthRespondeDto> Login(LoginRequestDto request)
    {
        var response = new AuthRespondeDto();
        try
        {
    ...
    public async Task<AuthRespondeDto> RefreshToken(string email)
    {
        var response = new AuthRespondeDto();
        try
        {
